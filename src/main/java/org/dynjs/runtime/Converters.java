...
public class Converters {
    ...
    static {
        ...
        DynAtom2boolean = Lookup.PUBLIC.findStatic(Converters.class, "convertDynAtom2boolean", methodType(Boolean.class, Object.class));
    }
    ...
    public static final GuardedInvocation Guarded_DynAtom2boolean = new GuardedInvocation(DynAtom2boolean,
            Guards.isInstance(DynAtom.class, methodType(boolean.class, Object.class)));
    ...
    public static Boolean convertDynAtom2boolean(Object value) {
