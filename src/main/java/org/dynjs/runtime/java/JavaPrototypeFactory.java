...
/**
 * Factory to create DynObject instances based upon Java classes annotated with
 * <code>@JavaPrototype</code> and <code>@JavaPrototypeFunction</code>.
 * 
 * @see JavaPrototype
...
public class JavaPrototypeFactory {
     ...
     * @return The new Javascript object, or <code>null</code> if the prototype
     *         class
