...
public class LinkerUtils {
    ...
    public static boolean isNonFunctionJavascriptDereferencedReference(Object o) {
        return (o instanceof DereferencedReference) && (((DereferencedReference) o).getValue() instanceof JSObject) && (!(((DereferencedReference) o).getValue() instanceof JSFunction));
    }
    ...
    public static MethodHandle nonFunctionJavascriptDereferencedReferenceGuard(Binder binder) throws NoSuchMethodException, IllegalAccessException {
        return binder.drop(1, binder.type().parameterCount() - 1)
                .invoke(MethodHandles.lookup().findStatic(LinkerUtils.class, "isNonFunctionJavascriptDereferencedReference", MethodType.methodType(boolean.class, Object.class)));
    }
