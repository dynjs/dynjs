 ...
 */
public class FunctionDereferencedReferenceConstructLink extends SmartLink implements Guard {

    public FunctionDereferencedReferenceConstructLink(LinkBuilder builder) throws Exception {
        super(builder);
    ...
    public MethodHandle guardMethodHandle(MethodType inputType) throws Exception {
        return lookup()
                .findVirtual(FunctionDereferencedReferenceConstructLink.class, "guard", methodType(boolean.class, Object.class, Object.class, Object[].class))
                .bindTo(this);
    }
