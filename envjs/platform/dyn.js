...
Envjs.platform       = "DynJS";
Envjs.revision       = "1.7.0.rc2";
Envjs.argv = [];
var argv = dynjs.getArgv();
for (v=0; v < argv.length; v++) {
  Envjs.argv[v] = argv[v];
}
...
Envjs.readConsole = function(){
	log = log||Envjs.logger('Envjs.DynJS');
...
var log = Envjs.logger('Envjs.HTML.DynJS');
...
var log = Envjs.logger('Envjs.Timer.DynJS');
// TODO: Figure out sync and spawn for DynJS
...
Envjs.onExit = function(callback){
  print("Envjs.onExit not implemented yet");
  // TODO: Figure out how to do this in DynJS
  //
...
var log = Envjs.logger('Envjs.XMLHttpRequest.DynJS');
...
var log = Envjs.logger('Envjs.Window.DynJS');
...
Envjs.proxy = function(scope, parent) {
  print("Envjs.proxy not yet implemented for DynJS");
//    try{
